...
gpg2 --encrypt --sign --recipient contact@ankitpati.in filename.br | brotli --decompress --output filename
gpg2 --encrypt --sign --recipient contact@ankitpati.in filename.br | brotli --decompress | grep service
