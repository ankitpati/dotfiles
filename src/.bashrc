...
main()
{
    ...
    PS1='\[\e[0;92m\]$(e=$?; if ((e != 0)); then printf \[\e[91m\]; fi; printf %03u $e)\[\e[0m\] \[\e[36m\]\D{%Y}\[\e[0m\]:\[\e[35m\]\D{%m}\[\e[0m\]:\[\e[33m\]\D{%d}\[\e[0m\]T\[\e[96m\]\D{%H}\[\e[0m\]:\[\e[95m\]\D{%M}\[\e[0m\]:\[\e[93m\]\D{%S}\[\e[34m\]\D{%z}\[\e[0m\] \u@\h \w \$ '
