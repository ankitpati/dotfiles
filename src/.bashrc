...
main()
{
    ...
    PS1='\[\e[32m\]$(case $? in 0) printf %03u $? ;; *) printf \[\e[31m\]%03u $? ;; esac)\[\e[0m\] \[\e[96m\]\D{%Y}\[\e[0m\]:\[\e[95m\]\D{%m}\[\e[0m\]:\[\e[93m\]\D{%d}\[\e[0m\]T\[\e[36m\]\D{%H}\[\e[0m\]:\[\e[35m\]\D{%M}\[\e[0m\]:\[\e[33m\]\D{%S}\[\e[34m\]\D{%z}\[\e[0m\] \u@\h \w \$ '
